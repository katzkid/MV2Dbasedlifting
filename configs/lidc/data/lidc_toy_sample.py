#
# This is config for running toy example for debug purpose
# The dataset only includes 2 patients. 
#
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'toy_infos.pkl',
        ann_file_2d=data_root + 'toy_infos_2d_anno.coco.json',
