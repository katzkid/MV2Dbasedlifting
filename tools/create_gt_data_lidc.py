...
def get_3d_annotation(root_dir, anno3d_dir, patient_id):
    ...
    with open(anno_3d_file, "r") as file:
        for line in file:
            ...
            # the coordinates in the txt file were stored as Y, X, Z (as well as the extension) [wrong]
            # the coordinates in txt file were stored as : X, dx, Y, dy, Z, dz
...
#
# Create folder paths to store data
#
...
#
# Build the ground truth 3D database. We follow the convention of Nuscene dataformat
# store in .pkl file
#
